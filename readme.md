...
[![Build Status](https://scrutinizer-ci.com/g/binaryversion/laravel-gmail/badges/build.png?b=master)](https://scrutinizer-ci.com/g/binaryversion/laravel-gmail/build-status/master)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/binaryversion/laravel-gmail/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/binaryversion/laravel-gmail/?branch=master)
[![GitHub issues](https://img.shields.io/github/issues/binaryversion/laravel-gmail.svg)](https://github.com/binaryversion/laravel-gmail/issues)
[![Total Downloads](https://poser.pugx.org/binaryversion/laravel-gmail/downloads)](https://packagist.org/packages/binaryversion/laravel-gmail)
[![Monthly Downloads](https://poser.pugx.org/binaryversion/laravel-gmail/d/monthly)](https://packagist.org/packages/binaryversion/laravel-gmail)
[![GitHub license](https://img.shields.io/github/license/binaryversion/laravel-gmail.svg)](https://github.com/binaryversion/laravel-gmail/blob/master/LICENSE)
...
Add binaryversion/laravel-gmail to composer.json.

`"binaryversion/laravel-gmail": "^5.0"`

Run composer update to pull down the latest version.

Or run

`composer require binaryversion/laravel-gmail`
 
Now open up `config/app.php` and add the service provider to your providers array.

``` php
'providers' => [
    Binaryversion\LaravelGmail\LaravelGmailServiceProvider::class,
]
```
...
``` php
'aliases' => [
    'LaravelGmail' => Binaryversion\LaravelGmail\Facade\LaravelGmail::class,
]
```
...
- Change your composer.json from `"binaryversion/laravel-gmail": "^1.0"` to `"binaryversion/laravel-gmail": "^2.0"`
...
The only changed made was the multi credentials feature.
- Change your composer.json from `"binaryversion/laravel-gmail": "^0.6"` to `"binaryversion/laravel-gmail": "^1.0"`
...
Run `php artisan vendor:publish --provider="Binaryversion\LaravelGmail\LaravelGmailServiceProvider"` and modify the config file `config/gmail.php`.
...
```
use Binaryversion\LaravelGmail\Services\Message\Mail;
...
```
use Binaryversion\LaravelGmail\Services\Message\Attachment
...
...
All the possible filters are in the [Filterable Trait](https://github.com/binaryversion/laravel-gmail/blob/master/src/Traits/Filterable.php)
